...
<body>
    ...
    <section class="body-container-shop">
        ...
        <div class="bc-admin">
            ...
            <table class="tb-admin">
                <thead>
                    <tr>
                        ...
                        <th>ชื่อ-สกุล</th>
                        <th class="th-btn-control-list">จัดการ</th>
                    </tr>
                </thead>
                <tbody>
            ...
            $count  = 1 ;
    $stmt = $pdo->query("select * from trading where status = 2 ");
    ...
    ?>
                    <tr>
                        ...
                        <td class="td-btn-control">
                            <a href="p-listDelivery.php?trading_id=<?php echo $row['trading_id'] ; ?>"  class="btn btn-success">จัดส่งแล้ว</a>
                        </td>
                    </tr>
                    <?php 
                    $count ++ ;
